...
데이터 분석부터 모델을 설계하고 이를 통해 서비스를 만드는 것까지의 전 과정을 프로젝트로 진행할 수 있어서 좋았습니다. 개인적으로 설계한 모델의 성능이 좋은 편이 아니라 아쉬움이 많이 남는 프로젝트였지만, 저의 부족한 점을 팀원분들을 통해서 많이 배울 수 있어서 좋은 프로젝트가 된 것 같습니다.
<br/>